      ...
      <div class="row">
        <div class="col-12">
          <a href="#" class="btn btn-primary">Ver Todos</a>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 text-center my-4">
                    <div class="card" style="width: 18rem;">
        <img src="https://shop.wilson.com/media/catalog/product/cache/38/small_image/210x/9df78eab33525d08d6e5fb8d27136e95/2/e/2ed1829bd17087f955470f3572e27091ad76e07c_wrz420100_premium_leather_replacement_grip.jpg" class="card-img-top" alt="Tecnifibreraquect">
        <div class="card-body">
            ...
            <div class="row">
              <div class="col-12">
                <a href="#" class="btn btn-primary">Ver Todos</a>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 text-center my-4">
                          <div class="card" style="width: 18rem;">
                            <img src="https://shop.wilson.com/media/catalog/product/cache/38/small_image/210x/9df78eab33525d08d6e5fb8d27136e95/e/b/eb1c3014c561f2b6d6203400d2de5b25789e0b3e_wrz403000_1.jpg" class="card-img-top" alt="Cuerdas">
                            <div class="card-body">
                <h5 class="card-title">Cubregrips</h5>
                  <div class="container">
                  <div class="row">
                    <div class="col-12">
                      <a href="#" class="btn btn-primary">Ver Todos</a>
